                            ...
                            @if ($top_categories->count())
                                <div class="f-size-14 banner-quciks-links " data-aos="" data-aos-duration="1000"
                                    ...
                                    @foreach ($top_categories as $item)
                                        <a href="{{ route('website.job.category.slug', ['category' => $item->slug]) }}">
                                            {{ $item->name }} {{ !$loop->last ? ',' : '' }}
                                        </a>
                                    @endforeach
                                </div>
            ...
            <div class="row g-3">
                ...
                @foreach ($popular_categories as $key => $category)
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <a href="{{ route('website.job.category.slug', $category['slug']) }}" class="popular-category-item">
                                    ...
                                    <div class="card-body">
                                        <div class="rt-single-icon-box">
                                            ...
                                            <div class="iconbox-content">
                                                <div class="">
                                                    <span
                                                        class="tw-text-[#191F33] tw-text-lg tw-font-medium tw-whitespace-nowrap tw-text-ellipsis tw-overflow-hidden tw-inline-block tw-max-w-[150px] xs:tw-max-w-[250px]">{{ $company->user->name }}</span>
                                                </div>
                                        ...
                                        <div class="post-info d-flex">
                                            <div class="flex-grow-1">
                                                @if ($company->jobs_count == 0)
                                                    <div type="button" class="d-block text-dark border-0 text-center">
                                                ...
                                                @else
                                                    <span type="button" class="btn btn-primary2-50 d-block">
                                                        <div class="button-content-wrapper ">
                                                            <span class="button-icon align-icon-right">
                                                                <i class="ph-arrow-right"></i>
                                                            </span>
