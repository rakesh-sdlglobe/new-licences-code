                    ...
                    <div class="dashboard-right">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="single-feature-box" style="background: rgb(244, 128, 147)">
                                    <div class="single-feature-data">
                                        {{-- <h6 class="tw-text-[#18191C] tw-text-2xl tw-font-semibold">{{ $appliedJobs }}</h6> --}}
                                        <p>{{ __('job_applied') }}</p>
                                    </div>
                                    <div class="single-feature-icon" style="background: pink">
                                        <i class="ph-suitcase-simple"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="single-feature-box" style="background: rgb(89, 198, 242)">
                                    <div class="single-feature-data">
                                        {{-- <h6 class="tw-text-[#18191C] tw-text-2xl tw-font-semibold">{{ $favoriteJobs }}</h6> --}}
                                        <p>{{ __('favorite_jobs') }}</p>
                                    </div>
                                    <div class="single-feature-icon" style="background: skyblue">
                                        <i class="ph-bookmark-simple"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="single-feature-box" style="background: rgb(247, 247, 106)">
                                    <div class="single-feature-data">
                                        {{-- <h6 class="tw-text-[#18191C] tw-text-2xl tw-font-semibold">{{ $notifications }}</h6> --}}
                                        <p>{{ __('job_alert') }}</p>
                                    </div>
                                    <div class="single-feature-icon" style="background: rgb(246, 246, 191)">
