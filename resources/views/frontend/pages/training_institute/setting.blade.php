...
@section('main')
    <div class="dashboard-wrapper">
        <div class="container">
            <div class="row">
                <x-website.training_institute.sidebar />
                <div class="col-lg-9">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <select
                                                        ...
                                                        <option
                                                         {{-- @if ($candidate->gender == 'other') selected @endif --}}
                                                            value="other">
                                                            {{ __('other') }}
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="card-footer row mt-4 border-0">
                                                ...
                                                <div class="location_secion">
                                                    {{ __('country') }}: <span
                                                        ...
                                                        {{-- {{ $candidate_country ?: $session_country }}
                                                    </span>
                                                    <br>
                                                    {{ __('full_address') }}: <span
                                                        class="location_full_address">
                                                        {{-- {{ $candidate_exact_location ?: $session_exact_location }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row rt-mb-18">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="start" value="{{ old('start') }}" placeholder="d/m/y"
                            ...
                            <div class="col-lg-6 experience_end_date">
                                ...
                                <input type="text" name="end" value="{{ old('end') }}" placeholder="d/m/y"
                        ...
                        <div class="row rt-mb-18">
                            <div class="col-lg-6">
                                ...
                                <input id="experience-modal-start" type="text" name="start"
                                    value="{{ old('start') }}" placeholder="d/m/y"
                                    class="date_picker form-control border-cutom @error('start') is-invalid @enderror"
                                    required>
                            </div>
                            <div class="col-lg-6 experience_end_date">
                                ...
                                <input id="experience-modal-end" type="text" name="end"
                                    value="{{ old('end') }}" placeholder="d/m/y"
                                    class="date_picker form-control border-cutom @error('end') is-invalid @enderror">
                            </div>
                        </div>
