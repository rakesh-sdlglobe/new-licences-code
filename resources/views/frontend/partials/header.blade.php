...
<header class="header rt-fixed-top">
    <div class="n-header">
        <div class="n-header--top relative" style=" background-image: linear-gradient(
        to right,
        hsl(193, 56%, 80%),
        hsl(325, 55%, 80%)
    ) !important;">
                                ...
                                <div class="d-flex align-items-center ">
                                    ...
                                    @auth('user')
                                        <ul
                                           ...
                                           @if (auth()->user()->role == 'training_institute') <!-- Check if the user role is 'training_institute' -->
                                                <li class="relative">
                                                    <a href="{{ route('user.dashboard') }} " class="training-institute-profile p-0">
                                                        <img src="{{ auth()->check() ? auth()->user()->trainingInstitute->logo_url : '' }}" alt="">
                                                    </a>
                                                </li>
                                            @else
                                                @company
                                                    <li class="relative">
                                                        <a href="{{ route('user.dashboard') }} " class="company-profile p-0">
                                                            <img src="{{ auth()->check() ? auth()->user()->company->logo_url : '' }}" alt="">
                                                        </a>
                                                    </li>
                                                @else
                                                    <li class="relative">
                                                        <a href="{{ route('user.dashboard') }} " class="candidate-profile p-0">
                                                            <img src="{{ auth()->check() ? auth()->user()->candidate->photo : '' }}" alt="">
                                                        </a>
                                                    </li>
                                                @endcompany
                                            @endif
                                            ...
                                            @if (!request()->is('email/verify'))
                                                @if (auth()->user()->role !== 'company' && auth()->user()->role !== 'candidate' && auth()->user()->role !== 'training_institute') <!-- Add 'training_institute' role check -->
                                                    <li>
