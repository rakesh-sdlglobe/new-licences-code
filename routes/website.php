...
use App\Http\Controllers\TrainingInstituteController;
...
Route::get('/email/verify/{id}/{hash}', function (EmailVerificationRequest $request) {
    ...
    if (authUser()->role == 'company') {
        ...
        return redirect()->route('training_institutes.dashboard', ['verified' => true]);
    }
...
// Global Routes
Route::get('/check/username/{name}', [GlobalController::class, 'checkUsername']);
Route::get('/translated/texts', [GlobalController::class, 'fetchCurrentTranslatedText']);
Route::post('ckeditor/upload', [WebsiteController::class, 'ckeditorImageUpload'])->name('ckeditor.upload');
...
Route::get('/training-institute/register', [TrainingInstituteController::class, 'showRegistrationForm'])->name('training-institute.register');
Route::post('/training-institute/register', [TrainingInstituteController::class, 'register']);
