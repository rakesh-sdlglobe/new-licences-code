...
use App\Http\Controllers\Admin\TrainingInstitutesController;
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        //training_institutes
        Route::resource('training_institute', TrainingInstitutesController::class);
        Route::post('training_institute/citylist', [TrainingInstituteController::class, 'getCityList'])->name('admin.getCityByCountry');
        Route::post('training_institute/statelist', [TrainingInstituteController::class, 'getStateList'])->name('admin.getStateByCountry');
        Route::get('training_institute/change/status', [TrainingInstituteController::class, 'statusChange'])->name('training_institute.status.change');
        Route::get('training_institute/verify/status', [TrainingInstituteController::class, 'verificationChange'])->name('training_institute.verify.change');
        Route::get('training_institute/profile/verify/status', [TrainingInstituteController::class, 'profileVerificationChange'])->name('training_institute.profile.verify.change');
